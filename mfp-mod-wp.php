...
load_plugin_textdomain('mfp-languages', PLUGINDIR.'/'.dirname(plugin_basename(__FILE__)).'/languages', dirname(plugin_basename(__FILE__)).'/languages');
...
function mfp_options_page() {
  ...
  if (isset($_FILES['filename']['name'])){
    ...
    if ($filetype == "jpg" || $filetype == "jpeg" || $filetype == "gif" || $filetype == "bmp" || $filetype == "png" && $_FILES['filename']['size'] != 0){
...
<div id="icon-options-general" class="icon32"><br /></div><h2><?php echo __('Configuration MFP mod WP','mfp-languages');?></h2>
<div class="metabox-holder container">
  <div class="sidebar1">
    <div class="postbox">
      ...
      <div class="inside">
      <hr />
      <p><?php echo __('Plugin MFP mod WP has two main functions: cleans your source code from the links that can slow down his work. and hides with the admin some items in particular version of the engine, links to wordpress.org etc.','mfp-languages');?></p>
      <p><?php echo __('Currently plugin under development, but its capabilities are constantly expanding.','mfp-languages');?></p>
      <p><?php echo __('<em>Attention!</em> Some options may cause astable work of your blog. In this case, disable it, or refrain from using this plugin if you are unsure what is. The plugin itself does not modify your files.','mfp-languages');?></p>
      </div>
    </div>
    <!--
    <div class="postbox">
...
<div class="content">
  ...
  <div class="postbox">
    ...
    <div class="inside">
      ...
      <p class="description"><?php echo __('<em>Removes wp_head links: </em> feed, rsd, wlwmanifest, index_rel, parent_post_rel, start_post_rel, adjacent_posts_rel, wp_shortlink and wp_generator.','mfp-languages');?></p>
      </div>
      ...
      <p class="description"><?php echo __('Removes comments html <br /> (type &lt;-- comment --&gt; ) with the source code. Does not alter any files!','mfp-languages');?></p>
      </div>
        <div class="styled-select">

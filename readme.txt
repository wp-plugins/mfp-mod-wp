...
Cleaning head of references to feed, manifest, wp generator, etc. Deleting comments in the source code. Removing logos and links in wp-admin panel.
...
1. Upload `mfp-mod-wp.zip` to the `/wp-content/plugins/` directory
